      ...
      <div class="grid gap-4 xl:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.9fr)]">
        <NCard class="rounded-[var(--ez-radius-sm)]" :bordered="false" content-class="p-6">
          ...
          <div class="flex items-start justify-between gap-4">
            <div>
              <p class="text-sm font-medium uppercase tracking-[0.24em] text-[var(--ez-text-light)]">
                Runtime Snapshot
              </p>
          ...
          <div class="grid gap-4 md:grid-cols-2">
            ...
            >
              ...
              <p class="mt-3 text-lg font-bold text-[var(--ez-text-main)]">{{ item.value || 'pending' }}</p>
            ...
            <div class="flex flex-col gap-3">
              ...
              >
                <div class="flex items-center justify-between gap-3">
                  ...
                  <code class="rounded bg-[var(--ez-page-bg)] px-2 py-1 text-xs text-[var(--ez-text-sub)]">
                    {{ endpoint.path }}
                  </code>
                </div>
                <p class="mt-2 text-sm leading-6 text-[var(--ez-text-sub)]">{{ endpoint.description }}</p>
              </article>
            </div>
          </NCard>
        </section>
