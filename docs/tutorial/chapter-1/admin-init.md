...
| 依赖 / 工具 | 用途 | 资料 |
| --- | --- | --- |
| Vue | 管理台前端框架 | [官方文档](https://vuejs.org/) |
| create-vue | Vue 官方项目脚手架 | [官方说明](https://github.com/vuejs/create-vue) |
| Vite | 前端开发服务和构建工具 | [官方文档](https://vite.dev/) |
