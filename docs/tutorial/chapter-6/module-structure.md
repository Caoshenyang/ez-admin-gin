...
| Migration | `server/migrations/{pgsql,mysql}/000XXX_seed_data.up.sql` | 初始化权限种子和菜单种子 |
...
- [ ] Migration 种子：在 `migrations/{pgsql,mysql}/000XXX_seed_data.up.sql` 中补齐权限和菜单初始数据
