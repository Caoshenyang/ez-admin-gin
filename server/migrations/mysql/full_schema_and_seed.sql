-- Generated from server/migrations/mysql/*.up.sql
...
-- ============================================================================
-- Source: mysql/000001_init_schema.up.sql
-- ============================================================================
-- 系统用户表
...
-- ============================================================================
-- Source: mysql/000002_seed_data.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000003_enterprise_foundation.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000004_phase4_dict_schema.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000005_phase4_dict_seed_data.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000006_phase4_attachment_schema.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000007_phase4_attachment_seed_data.up.sql
-- ============================================================================
INSERT IGNORE INTO `sys_menu` (`id`, `parent_id`, `type`, `code`, `title`, `path`, `component`, `icon`, `sort`, `status`, `remark`, `created_at`, `updated_at`)
...
-- ============================================================================
-- Source: mysql/000008_phase4_org_menu_seed_data.up.sql
-- ============================================================================
INSERT IGNORE INTO `sys_menu` (`id`, `parent_id`, `type`, `code`, `title`, `path`, `component`, `icon`, `sort`, `status`, `remark`, `created_at`, `updated_at`)
...
-- ============================================================================
-- Source: mysql/000009_phase4_menu_icon_alignment.up.sql
-- ============================================================================
...
-- ============================================================================
-- Source: mysql/000010_notification.up.sql
-- ============================================================================
-- +migrate Up
...
-- ============================================================================
-- Source: mysql/000011_notification_casbin_seed.up.sql
-- ============================================================================
-- +migrate Up
